...
#SBATCH --job-name=al_exp_outcome_lin             # Job name
#SBATCH --nodes=1                           # Number of nodes
#SBATCH --ntasks-per-node=112               # Number of cores per node
#SBATCH --mem=256G                           # Memory per node
#SBATCH --time=06:00:00                     # Time limit
#SBATCH --output=./logs/al_exp_outcome_lin.%j.out  # Standard output log
#SBATCH --error=./logs/al_exp_outcome_lin.%j.err   # Standard error log
...
python data_acquisition/al_exp_outcome_lin_batch.py
