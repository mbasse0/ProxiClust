...
#SBATCH --job-name=main_embeddings_al              # Job name
#SBATCH --nodes=1                           # Number of nodes
#SBATCH --ntasks-per-node=1                 # Number of cores per node
#SBATCH --mem=64G                           # Memory per node
#SBATCH --gpus=1                          # Number of GPUs
#SBATCH --time=06:00:00                     # Time limit
#SBATCH --output=./logs/main_embeddings_al.%j.out  # Standard output log
#SBATCH --error=./logs/main_embeddings_al.%j.err   # Standard error log
...
srun python main_embeddings_al.py "$@"
