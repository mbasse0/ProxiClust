...
#SBATCH --job-name=model_comparison            # Job name
#SBATCH --nodes=1                           # Number of nodes
#SBATCH --ntasks-per-node=112              # Number of cores per node
#SBATCH --mem=512G                           # Memory per node
#SBATCH --time=10:00:00                     # Time limit
#SBATCH --output=./logs/model_comparison.%j.out  # Standard output log
#SBATCH --error=./logs/model_comparison.%j.err   # Standard error log
...
python esm_and_ml/model_comparison.py
