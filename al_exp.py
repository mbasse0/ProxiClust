...
def get_from_epistasis_clusters(sequences, targets, clusters_generators, cycles, samples_per_cycle, folder_path, init_size=10, plot_corr=False):
    ...
    cluster_weights = {cluster: len(clusters[cluster]) for cluster in clusters}
...
def run_experiments(run_1=True, run_2=True, run_3=True, run_4=True, run_5=True, run_6=True, run_7=True, run_8= True, run_9=True, run_10=True, run_11=True, runs=5, cycles=10, samples_per_cycle=1, init_size=10, folder_path='runs/folder_unspecified'):
    ...
    for j in range(runs):
        ...
        if run_7:
            ...
            clusters_generators = [[3, 4, 7, 9, 5], [6, 2, 0, 5, 1], [0, 1, 6, 2, 5]]
            results7 = get_from_epistasis_clusters(embeddings, targets, clusters_generators, cycles, samples_per_cycle, folder_path, init_size, plot_corr)
...
folder_path = f'runs/{file_names}_{dataset_path}_{antibody}_{cycles}cycles_{samples_per_cycle}samples_per_cycle_{runs}runs_{init_size}init_size'
...
run_experiments(run_1=False, run_2=False, run_3=True, run_4=False, run_5=False, run_6=False, run_7=True, run_8=True, run_9=False, run_10=False, run_11=False, runs=runs, cycles=cycles, samples_per_cycle=samples_per_cycle, init_size=init_size, folder_path=folder_path)