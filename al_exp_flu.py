...
sequences_light = df["mutant_light"].tolist()
sequences_heavy = df["mutant_heavy"].tolist()

sequences = [sequences_light[i] + sequences_heavy[i] for i in range(len(sequences_light))]
...
def run_experiments(run_1=True, run_2=True, run_3=True, run_4=True, run_5=True, run_6=True, run_7=True, run_8= True, run_9=True, run_10=True, run_11=True, runs=5, cycles=10, samples_per_cycle=1, init_size=10, folder_path='runs/folder_unspecified'):
    ...
    for j in range(runs):
        ...
        if run_9:
            ...
            update_results(results, results9, "Diverse2 acquisition (min linkage)")
    ...
    plot_indiv_results(results['spearman'], labels, 'AllSpearman Correlation', folder_path)
...
folder_path = f'runs/{file_names}_{dataset_path}_{antibody}_{n_samples}samples_{cycles}cycles_{samples_per_cycle}samples_per_cycle_{runs}runs_{init_size}init_size'
print("Folder path", folder_path)
run_experiments(run_1=False, run_2=True, run_3=True, run_4=True, run_5=True, run_6=False, run_7=False, run_8=True, run_9=True, run_10=True, run_11=False, runs=runs, cycles=cycles, samples_per_cycle=samples_per_cycle, init_size=init_size, folder_path=folder_path)