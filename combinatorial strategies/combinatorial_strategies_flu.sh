...
#SBATCH --job-name=combinatorial_strategies_flu              # Job name
#SBATCH --nodes=1                           # Number of nodes
#SBATCH --ntasks-per-node=1                 # Number of cores per node
#SBATCH --mem=64G                           # Memory per node
#SBATCH --gpus=1                          # Number of GPUs
#SBATCH --time=06:00:00                     # Time limit
#SBATCH --output=./logs/combinatorial_strategies_flu.%j.out  # Standard output log
#SBATCH --error=./logs/combinatorial_strategies_flu.%j.err   # Standard error log
...
srun python combinatorial_strategies_flu.py
