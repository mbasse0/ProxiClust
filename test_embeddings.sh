...
#SBATCH --job-name=test-embeddings            # Job name
#SBATCH --nodes=1                           # Number of nodes
#SBATCH --ntasks-per-node=1                 # Number of cores per node
#SBATCH --mem=64G
#SBATCH --gpus=2
#SBATCH --time=00:45:00                     # Time limit hrs:min:sec
#SBATCH --output=./logs/test-embeddings.%j.out  # Standard output and error log
#SBATCH --error=./logs/test-embeddings.%j.err   # Error log
...
srun python --version
srun python test_embeddings.py
